...
const STRINGS = {
  he: {
    ...
    childrenExceedParent: 'הבנים חורגים מתקציב האב', lines: 'שורות', addLine: 'הוסף שורה', total: 'סה״כ', needOneLine: 'צריך לפחות שורה אחת עם סכום', buySelected: 'קנה נבחרים', selected: 'נבחרו', split: 'מפוצל',
    pending_approval: 'ממתין לאישור', requestedByCategory: 'מבוקש לפי קטגוריה', requestedByStatus: 'מבוקש לפי סטטוס',
  ...
  en: {
    ...
    childrenExceedParent: 'Children exceed the parent budget', lines: 'Lines', addLine: 'Add line', total: 'Total', needOneLine: 'Need at least one line with an amount', buySelected: 'Buy selected', selected: 'selected', split: 'Split',
    pending_approval: 'Pending approval', requestedByCategory: 'Requested by category', requestedByStatus: 'Requested by status',
